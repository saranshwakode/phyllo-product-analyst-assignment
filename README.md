...
I worked on the provided API documentation and order responses to:

* Compare the documented API behavior with actual responses
* Identify data and API inconsistencies
* Validate and reconcile revenue calculations
* Identify the business impact of the issues found
* Prepare a customer-facing response
* Create an engineering bug report with suggested fixes

I also created a supporting Excel file to document the revenue calculations and normalization.
...
**API Analysis**
Documentation vs. actual API responses, data inconsistencies, pagination, status values, and missing data.

**Revenue Analysis**
Monetary normalization, total validation, discrepancy identification, and revenue reconciliation.
